(()=>{var O="com.nhitw.host";function k(e){return new Promise((a,t)=>{try{let n=chrome.runtime.connectNative(O),o=!1;n.onMessage.addListener(s=>{o=!0,n.disconnect(),s.success?a(s):t(new Error(s.message||s.error||"Unknown host error"))}),n.onDisconnect.addListener(()=>{if(!o){let s=chrome.runtime.lastError?.message||"Native host disconnected";t(new Error(s))}}),n.postMessage(e)}catch(n){t(new Error(`Native messaging unavailable: ${n.message}`))}})}async function $(e,a,t){return k({action:"write_html",filename:e,content:a,date:t||void 0})}function _(e,a,t){let o=j(new Date),s=[];return t.medicationData?.rObject?.length&&s.push(A(t.medicationData.rObject)),t.chinesemedData?.rObject?.length&&s.push(C(t.chinesemedData.rObject)),t.labData?.rObject?.length&&s.push(M(t.labData.rObject)),t.imagingData?.rObject?.length&&s.push(T(t.imagingData.rObject)),t.allergyData?.rObject?.length&&s.push(N(t.allergyData.rObject)),t.surgeryData?.rObject?.length&&s.push(U(t.surgeryData.rObject)),t.dischargeData?.rObject?.length&&s.push(F(t.dischargeData.rObject)),t.medDaysData?.rObject?.length&&s.push(P(t.medDaysData.rObject)),s.length===0&&s.push('<div class="section"><h2>\u7121\u8CC7\u6599</h2><p>\u5C1A\u672A\u64F7\u53D6\u5230\u4EFB\u4F55\u91AB\u7642\u8CC7\u6599\u3002</p></div>'),I(e,a,o,s.join(`
`))}function x(e,a){let t=a||new Date,n=t.getFullYear(),o=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0"),d=String(t.getHours()).padStart(2,"0"),c=String(t.getMinutes()).padStart(2,"0");return`${e.replace(/[\\/:*?"<>|]/g,"_")}_${n}${o}${s}_${d}${c}.html`}function j(e){return`${e.getFullYear()}/${String(e.getMonth()+1).padStart(2,"0")}/${String(e.getDate()).padStart(2,"0")} ${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}function r(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function m(e){return e?e.includes("T")?e.split("T")[0]:e.replace(/\//g,"-"):""}function f(e){return e?e.split(";")[0].trim():""}function A(e){let a=S(e,n=>`${n.PER_DATE||n.drug_date||""}|${f(n.HOSP_NAME||n.hosp)}`),t="";for(let[n,o]of Object.entries(a)){let[s,d]=n.split("|"),c=o[0]?.ICD_CODE||o[0]?.icd_code||"",u=o[0]?.ICD_NAME||o[0]?.icd_cname||"";t+=`<tr class="group-header"><td colspan="6">${r(m(s))} \u2014 ${r(d)} ${c?`(${r(c)} ${r(u)})`:""}</td></tr>`;for(let i of o){let h=i.MED_DESC||i.MED_ITEM||i.drug_ename||"",g=i.GENERIC_NAME||i.drug_ing_name||"",b=i.DOSAGE||i.qty||"",D=i.FREQ_DESC||i.drug_fre||"",w=i.MED_DAYS||i.day||"",E=i.ATC_NAME||i.drug_atc5_name||"";t+=`<tr>
        <td>${r(h)}${g?`<br><span class="sub">${r(g)}</span>`:""}</td>
        <td>${r(b)}</td><td>${r(D)}</td><td>${r(w)}</td>
        <td>${r(E)}</td></tr>`}}return`<div class="section">
    ...
    <div class="section-body">
      ...
      <tbody>${t}</tbody></table>
    </div></div>`}function C(e){let a=S(e,n=>`${n.func_date||""}|${f(n.hosp)}`),t="";for(let[n,o]of Object.entries(a)){let[s,d]=n.split("|"),c=o[0]?.icd_code||"",u=o[0]?.icd_cname||"";t+=`<tr class="group-header"><td colspan="4">${r(m(s))} \u2014 ${r(d)} ${c?`(${r(c)} ${r(u)})`:""}</td></tr>`;for(let i of o){let h=i.drug_perscrn_name||i.cdrug_name||"",g=i.order_qty||"",b=i.drug_fre||"",D=i.day||"";t+=`<tr><td>${r(h)}</td><td>${r(g)}</td><td>${r(b)}</td><td>${r(D)}</td></tr>`}}return`<div class="section">
    <h2 onclick="toggleSection(this)">\u25B8 \u4E2D\u85E5\u7528\u85E5\u7D00\u9304 (${e.length})</h2>
    <div class="section-body">
      <table><thead><tr><th>\u85E5\u54C1\u540D\u7A31</th><th>\u5291\u91CF</th><th>\u983B\u7387</th><th>\u5929\u6578</th></tr></thead>
      <tbody>${t}</tbody></table>
    </div></div>`}function M(e){let a=S(e,n=>`${n.real_inspect_date||n.recipe_date||""}|${f(n.hosp)}`),t="";for(let[n,o]of Object.entries(a)){let[s,d]=n.split("|");t+=`<tr class="group-header"><td colspan="5">${r(m(s))} \u2014 ${r(d)}</td></tr>`;for(let c of o){let u=c.order_name||c.assay_item_name||"",i=c.assay_value||"",h=c.consult_value||"",g=c.unit_data||"",b=H(i,h);t+=`<tr>
        <td>${r(u)}</td>
    ...
    <div class="section-body">
      ...
      <tbody>${t}</tbody></table>
    </div></div>`}function T(e){let a="";for(let t of e){let n=t.real_inspect_date||t.case_time||t.recipe_date||"",o=f(t.hosp),s=t.order_name||"",d=t.inspect_result||"",c=t.cure_path_name||"";a+=`<tr><td>${r(m(n))}</td><td>${r(o)}</td><td>${r(s)}</td><td>${r(c)}</td><td>${r(d)}</td></tr>`}return`<div class="section">
    <h2 onclick="toggleSection(this)">\u25B8 \u5F71\u50CF\u6AA2\u67E5 (${e.length})</h2>
    <div class="section-body">
      <table><thead><tr><th>\u65E5\u671F</th><th>\u91AB\u9662</th><th>\u6AA2\u67E5\u9805\u76EE</th><th>\u90E8\u4F4D</th><th>\u5831\u544A</th></tr></thead>
      <tbody>${a}</tbody></table>
    </div></div>`}function N(e){let a=e.filter(n=>{let o=n.drug_name||"";return o&&!o.includes("\u672A\u8A18\u9304")&&o!=="NP"&&o!=="N.P"&&o!=="N.P."&&!o.includes("\u672A\u904E\u654F")});if(a.length===0)return`<div class="section">
      <h2 onclick="toggleSection(this)">\u25B8 \u904E\u654F\u7D00\u9304</h2>
      <div class="section-body"><p>\u7121\u904E\u654F\u7D00\u9304</p></div></div>`;let t="";for(let n of a){let o=n.upload_d||"",s=n.drug_name||"",d=(n.sympton_name||"").replace(/;/g,", "),c=n.allerg_severity_level||"",u=f(n.hosp);t+=`<tr><td>${r(o)}</td><td>${r(s)}</td><td>${r(d)}</td><td>${r(c)}</td><td>${r(u)}</td></tr>`}return`<div class="section">
    <h2 onclick="toggleSection(this)">\u25B8 \u904E\u654F\u7D00\u9304 (${a.length})</h2>
    <div class="section-body">
      <table><thead><tr><th>\u65E5\u671F</th><th>\u85E5\u54C1</th><th>\u75C7\u72C0</th><th>\u56B4\u91CD\u5EA6</th><th>\u91AB\u9662</th></tr></thead>
      <tbody>${t}</tbody></table>
    </div></div>`}function U(e){let a="";for(let t of e){let n=t.exe_s_date||"",o=f(t.hosp),s=t.icd_code||"",d=t.icd_cname||"";a+=`<tr><td>${r(m(n))}</td><td>${r(o)}</td><td>${r(s)}</td><td>${r(d)}</td></tr>`}return`<div class="section">
    <h2 onclick="toggleSection(this)">\u25B8 \u624B\u8853\u7D00\u9304 (${e.length})</h2>
    <div class="section-body">
      <table><thead><tr><th>\u65E5\u671F</th><th>\u91AB\u9662</th><th>\u4EE3\u78BC</th><th>\u540D\u7A31</th></tr></thead>
      <tbody>${a}</tbody></table>
    </div></div>`}function F(e){let a="";for(let t of e){let n=t.in_date||"",o=t.out_date||"",s=f(t.hosp),d=t.icd_code||"",c=t.icd_cname||"";a+=`<tr><td>${r(m(n))}</td><td>${r(m(o))}</td><td>${r(s)}</td><td>${r(d)}</td><td>${r(c)}</td></tr>`}return`<div class="section">
    <h2 onclick="toggleSection(this)">\u25B8 \u51FA\u9662\u6458\u8981 (${e.length})</h2>
    <div class="section-body">
      <table><thead><tr><th>\u5165\u9662\u65E5</th><th>\u51FA\u9662\u65E5</th><th>\u91AB\u9662</th><th>\u4EE3\u78BC</th><th>\u8A3A\u65B7</th></tr></thead>
      <tbody>${a}</tbody></table>
    </div></div>`}function P(e){let a="";for(let t of e){let n=t.MED_DESC||t.MED_ITEM||t.drug_ename||"",o=t.DRUG_LEFT||t.drug_left||"",s=t.PER_DATE||t.drug_date||"",d=f(t.HOSP_NAME||t.hosp);a+=`<tr><td>${r(n)}</td><td>${r(o)}</td><td>${r(m(s))}</td><td>${r(d)}</td></tr>`}return`<div class="section">
    <h2 onclick="toggleSection(this)">\u25B8 \u9918\u85E5\u5929\u6578 (${e.length})</h2>
    <div class="section-body">
      <table><thead><tr><th>\u85E5\u54C1</th><th>\u9918\u85E5\u5929\u6578</th><th>\u958B\u7ACB\u65E5\u671F</th><th>\u91AB\u9662</th></tr></thead>
      <tbody>${a}</tbody></table>
    </div></div>`}function S(e,a){let t={};for(let n of e){let o=a(n);t[o]||(t[o]=[]),t[o].push(n)}return t}function H(e,a){if(!e||!a||e==="***")return!1;let t=parseFloat(e);if(isNaN(t))return!1;let n=a.match(/([\d.]+)\s*[-~]\s*([\d.]+)/);if(n){let d=parseFloat(n[1]),c=parseFloat(n[2]);return t<d||t>c}let o=a.match(/[<≦]\s*([\d.]+)/);if(o)return t>parseFloat(o[1]);let s=a.match(/[>≧]\s*([\d.]+)/);return s?t<parseFloat(s[1]):!1}function I(e,a,t,n){return`<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
