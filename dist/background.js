(()=>{var J="com.nhitw.host";function Q(t){return new Promise((o,e)=>{try{let n=chrome.runtime.connectNative(J),r=!1;n.onMessage.addListener(i=>{r=!0,n.disconnect(),i.success?o(i):e(new Error(i.message||i.error||"Unknown host error"))}),n.onDisconnect.addListener(()=>{if(!r){let i=chrome.runtime.lastError?.message||"Native host disconnected";e(new Error(i))}}),n.postMessage(t)}catch(n){e(new Error(`Native messaging unavailable: ${n.message}`))}})}async function L(t,o,e){return Q({action:"write_html",filename:t,content:o,date:e||void 0})}function j(t,o,e){let r=X(new Date),i=ce(e),c=de(e),s=ee(e,{acu:i,cancer:c}),u=te(e.labData?.rObject),f=be(e.medicationData?.rObject,100),b=Ce(e.medicationData?.rObject,100),l=ve(e.chinesemedData?.rObject),m=De(e.imagingData?.rObject),g=_e(e.allergyData?.rObject),p=xe(e.surgeryData?.rObject),C=Se(e.dischargeData?.rObject),_=le(e),M=pe(e);return $e(t,o,r,{diagnosisHtml:s,labPivotHtml:u,westMedHtml:f,otherWestMedHtml:b,chineseMedHtml:l,imagingHtml:m,allergyHtml:g,surgeryHtml:p,dischargeHtml:C,acuBadgeHtml:_,cancerBadgeHtml:M})}function U(t,o){let e=o||new Date,n=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),i=String(e.getDate()).padStart(2,"0"),c=String(e.getHours()).padStart(2,"0"),a=String(e.getMinutes()).padStart(2,"0");return`${t.replace(/[\\/:*?"<>|]/g,"_")}_${n}${r}${i}_${c}${a}.html`}function X(t){return`${t.getFullYear()}/${String(t.getMonth()+1).padStart(2,"0")}/${String(t.getDate()).padStart(2,"0")} ${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}function d(t){return t?String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function v(t){return t?t.includes("T")?t.split("T")[0]:t.replace(/\//g,"-"):""}function x(t){let o=v(t);if(!o)return"";let e=o.split("-");return e.length===3?`${e[1]}/${e[2]}`:o}function V(t){let o=v(t);if(!o)return"";let e=o.split("-");return e.length===3?`${e[0]}/${e[1]}/${e[2]}`:o}function $(t){return t?t.split(";")[0].trim():""}function ee(t,o={}){let n=o.acu||new Set,r=o.cancer||new Set,i=p=>{let C=String(p||"").trim(),_=[];return n.has(C)&&_.push("diag-acu-match"),r.has(C)&&_.push("diag-cancer-match"),_.join(" ")},c={},a=[],s={},u=[];function f(p,C,_,M,Y,P){if(p)for(let A of p){let I=A[C]||"";if(!w(I,180))continue;let y=A[M]||"",E=A[Y]||"";if(!y||!E)continue;let G=(A[_]||"").split(";"),k=G[0]?.trim()||"",T=G[1]?.trim()||"\u9580\u8A3A",Z=P&&A[P]||"";if(/^Z2[3-7]/.test(y)&&Z.startsWith("J07")){u.push({code:y,name:E,date:v(I),hosp:k});continue}T.includes("\u6025\u8A3A")?a.push({code:y,name:E,date:v(I),hosp:k}):T.includes("\u4F4F\u8A3A")||T.includes("\u4F4F\u9662")?s[y]||(s[y]={code:y,name:E,date:v(I),hosp:k}):(c[y]||(c[y]={code:y,name:E,count:0}),c[y].count++)}}f(t.medicationData?.rObject,"PER_DATE","HOSP_NAME","ICD_CODE","ICD_NAME","ATC_CODE");let b=t.medicationData?.rObject||[];b.length>0&&!b[0].PER_DATE&&f(b,"drug_date","hosp","icd_code","icd_cname","drug_atc7_code"),f(t.chinesemedData?.rObject,"func_date","hosp","icd_code","icd_cname",null);let l="",m=Object.values(c).sort((p,C)=>C.count-p.count);if(m.length>0){for(let p of m.slice(0,8))l+=`<div class="diag-item ${i(p.code)}"><span class="diag-code">${d(p.code)}</span> ${d(p.name)} <span class="diag-count">${p.count}</span></div>`;m.length>8&&(l+=`<div class="diag-more">\u9084\u6709 ${m.length-8} \u7B46</div>`)}if(a.length>0){l+='<div class="visit-type-label emergency-label">\u6025\u8A3A</div>';for(let p of a.slice(0,5))l+=`<div class="diag-item ${i(p.code)}"><span class="diag-code">${d(p.code)}</span> ${d(p.name)} <span class="diag-meta">${d(p.date)}</span></div>`}let g=Object.values(s);if(g.length>0){l+='<div class="visit-type-label inpatient-label">\u4F4F\u8A3A</div>';for(let p of g.slice(0,5))l+=`<div class="diag-item ${i(p.code)}"><span class="diag-code">${d(p.code)}</span> ${d(p.name)}</div>`}if(u.length>0){l+='<div class="visit-type-label vaccine-label">\u75AB\u82D7</div>';for(let p of u.slice(0,5))l+=`<div class="diag-item ${i(p.code)}"><span class="diag-code">${d(p.code)}</span> ${d(p.name)} <span class="diag-meta">${d(p.date)}</span></div>`}return l||'<p class="empty">\u7121\u8A3A\u65B7\u7D00\u9304</p>'}var B=[{orderCode:"08011C",name:"Hb",enabled:!0,subItem:"Hb"},{orderCode:"09002C",name:"BUN",enabled:!0},{orderCode:"09015C",name:"Cr",enabled:!0,subItem:"Cr"},{orderCode:"09015C",name:"GFR",enabled:!0,subItem:"GFR"},{orderCode:"09040C",name:"UPCR",enabled:!0},{orderCode:"12111C",name:"UACR",enabled:!0},{orderCode:"09038C",name:"Alb",enabled:!0},{orderCode:"09005C",name:"Glucose",enabled:!0},{orderCode:"09006C",name:"HbA1c",enabled:!0},{orderCode:"09001C",name:"Chol",enabled:!0},{orderCode:"09004C",name:"TG",enabled:!0},{orderCode:"09043C",name:"HDL",enabled:!0},{orderCode:"09044C",name:"LDL",enabled:!0},{orderCode:"09021C",name:"Na",enabled:!0},{orderCode:"09022C",name:"K",enabled:!0},{orderCode:"09013C",name:"U.A",enabled:!0},{orderCode:"09025C",name:"GOT",enabled:!0},{orderCode:"09026C",name:"GPT",enabled:!0}];function te(t){if(!t||t.length===0)return'<p class="empty">\u7121\u6AA2\u9A57\u8CC7\u6599</p>';let o=180,e=t.filter(l=>{let m=l.assay_value;if(!m||String(m).trim()===""||String(m).trim()==="***")return!1;let g=l.real_inspect_date||l.recipe_date||"";return w(g,o)});if(e.length===0)return'<p class="empty">\u7121\u6AA2\u9A57\u8CC7\u6599</p>';function n(l){let m=l.order_code||"",g=(l.assay_item_name||l.order_name||"").toLowerCase();if(m==="08011C"){if(g.includes("hb")||g.includes("hemoglobin")||g.includes("\u8840\u8272\u7D20"))return"Hb";if(g.includes("wbc")||g.includes("\u767D\u8840\u7403"))return"WBC";if(g.includes("plt")||g.includes("platelet")||g.includes("\u8840\u5C0F\u677F"))return"Platelet"}if(m==="09015C")return g.includes("gfr")||g.includes("\u814E\u7D72\u7403")?"GFR":"Cr";if(m==="09040C"&&(g.includes("upcr")||g.includes("protein")))return"UPCR";if(m==="12111C"&&(g.includes("uacr")||g.includes("albumin")))return"UACR";let p=B.find(C=>C.orderCode===m&&!C.subItem);return p?p.name:l.assay_item_name||l.order_name||m||"?"}let r=new Set,i={},c=0;for(let l of e){let m=v(l.real_inspect_date||l.recipe_date||"");if(!m)continue;let g=String(l.assay_value).trim(),p=l.consult_value||"",C=n(l);r.add(m),i[C]||(i[C]={name:C,code:l.order_code||"",dates:{},order:c++}),i[C].dates[m]={value:g,ref:p,dir:ae(g,p)}}let a=[...r].sort((l,m)=>m.localeCompare(l)),s=new Map;B.forEach((l,m)=>{s.has(l.name)||s.set(l.name,m)});let u=Object.keys(i).sort((l,m)=>{let g=s.has(l)?s.get(l):1e3+i[l].order,p=s.has(m)?s.get(m):1e3+i[m].order;return g-p});if(a.length===0||u.length===0)return'<p class="empty">\u7121\u6AA2\u9A57\u8CC7\u6599</p>';let f='<tr><th class="lab-item-col">\u9805\u76EE</th>';for(let l of a)f+=`<th class="lab-date-col">${d(V(l))}</th>`;f+="</tr>";let b="";for(let l of u){let m=i[l];b+=`<tr><td class="lab-item-name" title="${d(m.code)}">${d(l)}</td>`;for(let g of a){let p=m.dates[g];if(p){let C=p.dir==="high"?"lab-high":p.dir==="low"?"lab-low":"";b+=`<td class="${C}" title="${d(p.ref)}">${d(p.value)}</td>`}else b+='<td class="no-data">-</td>'}b+="</tr>"}return`<div class="lab-scroll"><table class="lab-pivot"><thead>${f}</thead><tbody>${b}</tbody></table></div>
  <div class="tracking-note">${o} \u5929\u5167 \xB7 ${u.length} \u9805 \xD7 ${a.length} \u6B21</div>`}function ae(t,o){if(!t||!o||t==="***")return null;let e=parseFloat(t);if(isNaN(e))return null;let n=o.match(/([\d.]+)\s*[-~]\s*([\d.]+)/);if(n){let c=parseFloat(n[1]),a=parseFloat(n[2]);return e>a?"high":e<c?"low":null}let r=o.match(/[<≦]\s*([\d.]+)/);if(r)return e>parseFloat(r[1])?"high":null;let i=o.match(/[>≧]\s*([\d.]+)/);return i&&e<parseFloat(i[1])?"low":null}var ne=["G43","G50","G51","G52","G54","G61","G62","G63","G65","G90","M13.0","M15","M20","M21","M66","H02","H04","H05","H10","H20","H25","H26","H52"],oe=["A15","B01","B02","B05","B06","B20","B97.2","B97.3","D65","D66","D67","D68","D69","D70","D82","D83","D84","E04","E05","E06","E10","E11","E13","E15","E28","F90","F95","I20","I21","I22","I23","I24","I25","I26","I27","I28","I42","I50","I71","I73","I74","I80","I82","I89","J44","J45","J93","J96","J98","K72","K74","K80","L10","L11","L12","L40","L51","L52","L89","L94","L97","M33","M34","M35","N18","N19","R64"],re=["A80","D32","D33","D48","D49","F02","F03","F04","F05","F09","F20","F21","F22","F23","F24","F25","F30","F31","F32","F33","F34","F35","F36","F37","F38","F39","F80","F82","F84","G11","G12","G20","G21","G35","G36","G40","G45","G46","G70","G71","G80","G81","G82","G83","G91","G93","G94","H30","H31","H33","H34","H35","H36","H40","H42","H43","H46","H47","H49","H50","H51","H53","H54","H55","I60","I61","I62","I63","I65","I66","I67","I69","M45","M62.3","M99","P91","Q11","Q12","Q13","Q14","Q15","S01.9","S04","S06.3","S06.4","S06.5","S06.6","S14","S22","S24","S32","S34","S44","S54","S64","S74","S84","S94"];function S(t,o){if(!t||!o)return!1;let e=String(t).replace(/\./g,"").toUpperCase().trim(),n=String(o).replace(/\./g,"").toUpperCase().trim();return!e||!n?!1:e===n||e.startsWith(n)}function ie(t){let o=t&&String(t).toUpperCase().replace(/\./g,"").match(/^C(\d{2})/);if(!o)return!1;let e=parseInt(o[1],10);return e>=0&&e<=96}function se(t){let o=t&&String(t).toUpperCase().replace(/\./g,"").match(/^O(\d{2})/);if(!o)return!1;let e=parseInt(o[1],10);return e>=10&&e<=16||e>=20&&e<=29}function N(t){let o=new Set,e=["ICD_CODE","icd_code","ICD_CODE_1","icd_code_1","ICD_CODE_2","icd_code_2","ICD_CODE_3","icd_code_3","ICD_CODE_4","icd_code_4","ICD_CODE_5","icd_code_5","icdCode","icdcode","ICD10_CODE","icd10_code","main_icd","sub_icd","MAIN_ICD","SUB_ICD","DIAG_CODE","diag_code"],n=i=>{if(Array.isArray(i)){for(let c of i)if(!(!c||typeof c!="object"))for(let a of e){let s=c[a];s&&o.add(String(s).trim())}}};n(t.medicationData?.rObject),n(t.chinesemedData?.rObject),n(t.dischargeData?.rObject),n(t.surgeryData?.rObject),n(t.patientSummaryData?.rObject);let r=Array.from(o).filter(Boolean);return console.log("[NHITW Clinic] Collected ICD codes for classification:",r),r}function R(t){let o=new Set,e=new Set,n=new Set;for(let r of t)(ie(r)||re.some(i=>S(r,i)))&&o.add(r),ne.some(i=>S(r,i))&&e.add(r),(se(r)||oe.some(i=>S(r,i)))&&n.add(r);return{high:[...o],moderate:[...e],special:[...n]}}function z(t){return t.high.length>0||t.moderate.length>0&&t.special.length>0?"high":t.moderate.length>0||t.special.length>0?"moderate":null}function ce(t){let o=N(t),e=R(o);if(!z(e))return new Set;let r=new Set;return e.high.forEach(i=>r.add(i)),e.moderate.forEach(i=>r.add(i)),e.special.forEach(i=>r.add(i)),r}function de(t){let o=N(t),e=W(o),n=new Set;for(let r of e)for(let i of r.hits)n.add(i);return n}function le(t){let o=N(t),e=R(o),n=z(e);if(console.log("[NHITW Clinic] Acupuncture matches:",e,"level:",n),!n)return"";let r,i;n==="high"?(r="\u26A1 \u9AD8\u5EA6\u8907\u96DC\u91DD\u7078",e.high.length>0?i=e.high:i=[...e.moderate.map(u=>u+"(\u4E2D)"),...e.special.map(u=>u+"(\u7279)")]):(r="\u{1F489} \u4E2D\u5EA6\u8907\u96DC\u91DD\u7078",i=[...e.moderate,...e.special.map(u=>u+"(\u7279)")]);let c=i.slice(0,12).join(", "),a=i.length>12?`\u2026 (+${i.length-12})`:"",s=`\u7B26\u5408 ICD: ${c}${a}`;return`<span class="acu-badge acu-${n}" title="${d(s)}">${r}</span>`}var ue=[{name:"\u4E73\u764C",primary:["C50","C79.81"],mets:["C77","C78.0","C78.1","C78.2","C78.3","C78.7","C79.2","C79.3","C79.5","C79.6","C79.7"],secondary:["C50","Z85.3"]},{name:"\u809D\u764C",primary:["C22","C23","C24"],mets:["C77","C78.0","C78.1","C78.2","C78.4","C78.5","C78.6","C78.7","C78.8","C79.3","C79.5","C79.7","Z94.4"],secondary:["C22","C23","C24","Z85.05"]},{name:"\u80BA\u764C",primary:["C33","C34"],mets:["C77","C78.0","C78.1","C78.2","C78.3","C78.7","C79.3","C79.5","C79.6","C79.7","Z94.2"],secondary:["C33","C34","Z85.1"]},{name:"\u5927\u8178\u764C",primary:["C18","C19","C20","C21"],mets:["C77","C78.0","C78.1","C78.2","C78.4","C78.5","C78.6","C78.7","C78.8","C79.0","C79.3","C79.5","C79.6","C79.7"],secondary:["C18","C19","C20","C21","Z85.04"]},{name:"\u80C3\u764C",primary:["C16","C49.A1","C49.A2"],mets:["C77","C78.0","C78.1","C78.2","C78.3","C78.7","C79.2","C79.3","C79.5","C79.6","C79.7"],secondary:["C16","C49.A1","C49.A2","Z85.028"]},{name:"\u651D\u8B77\u817A\u764C",primary:["C61"]},{name:"\u53E3\u8154\u764C",primary:["C01","C02","C03","C04","C05","C06","C07","C08","C09","C10"]},{name:"\u5B50\u5BAE\u9838\u764C",primary:["C53"]},{name:"\u5B50\u5BAE\u9AD4\u764C",primary:["C54"]},{name:"\u7532\u72C0\u817A\u764C",primary:["C73"]}];function W(t){let o=[];for(let e of ue){let n=new Set,r=!1;for(let i of t)e.primary.some(c=>S(i,c))&&(n.add(i),r=!0);if(e.mets&&e.secondary){let i=t.filter(a=>e.mets.some(s=>S(a,s))),c=t.filter(a=>e.secondary.some(s=>S(a,s)));i.length>0&&c.length>0&&(i.forEach(a=>n.add(a)),c.forEach(a=>n.add(a)),r=!0)}r&&o.push({name:e.name,hits:[...n]})}return o}function pe(t){let o=N(t),e=W(o);if(console.log("[NHITW Clinic] Cancer-care detected:",e),e.length===0)return"";let n=e.map(s=>s.name).join("\u3001"),r=[...new Set(e.flatMap(s=>s.hits))],i=r.slice(0,15).join(", "),c=r.length>15?`\u2026 (+${r.length-15})`:"",a=`\u7B26\u5408\u4E2D\u91AB\u764C\u75C7\u52A0\u5F37\u7167\u8B77\u65B9\u6848\uFF1A${n}
\u547D\u4E2D ICD: ${i}${c}`;return`<span class="cancer-badge" title="${d(a)}">\u{1F397} \u764C\u75C7\u5C08\u6848\uFF08${d(n)}\uFF09</span>`}var me={NSAID:["M01AA","M01AB","M01AC","M01AE","M01AG","M01AH"],ACEI:["C09AA","C09BA","C09BB","C09BX"],ARB:["C09CA","C09DA","C09DB","C09DX"],STATIN:["C10AA","C10BA","C10BX"],SGLT2:["A10BK","A10BD15","A10BD16","A10BD19","A10BD20","A10BD21","A10BD25","A10BD27","A10BD29","A10BD30"],GLP1:["A10BJ","A10AE54","A10AE56"],\u6297\u51DD:["B01A"]},ge={red:["\u6297\u51DD","NSAID"],orange:["ARB","ACEI","STATIN"],green:["SGLT2","GLP1"]},fe={red:{bg:"#fde8e8",border:"#e53935",text:"#b71c1c"},orange:{bg:"#fff3e0",border:"#fb8c00",text:"#e65100"},green:{bg:"#e8f5e9",border:"#43a047",text:"#1b5e20"}};function q(t){if(!t)return null;for(let[o,e]of Object.entries(me))if(e.some(n=>n.length===7?t===n:t.startsWith(n)))return o;return null}function he(t){for(let[o,e]of Object.entries(ge))if(e.includes(t))return o;return null}function w(t,o){if(!t)return!1;let e=new Date(t);return isNaN(e.getTime())&&t.includes("/")&&(e=new Date(t.replace(/\//g,"-"))),isNaN(e.getTime())?!1:Date.now()-e.getTime()<=o*864e5}function be(t,o){if(!t||t.length===0)return'<p class="empty">\u7121\u897F\u85E5\u7D00\u9304</p>';let e=o||100,n=[];for(let a of t){let s=a.PER_DATE||a.drug_date||"";if(!w(s,e))continue;let u=a.ATC_CODE||a.drug_atc7_code||"",f=q(u);if(!f)continue;let b=he(f);b&&n.push({name:a.MED_DESC||a.MED_ITEM||a.drug_ename||"",generic:a.GENERIC_NAME||a.drug_ing_name||"",date:v(s),hosp:$(a.HOSP_NAME||a.hosp),freq:a.FREQ_DESC||a.drug_fre||"",medDays:a.MED_DAYS||a.day||"",drugLeft:a.DRUG_LEFT||a.drug_left||"",groupName:f,colorName:b})}if(n.length===0)return'<p class="empty">\u7121\u95DC\u6CE8\u897F\u85E5\u7D00\u9304</p>';let r=["red","orange","green"],i={};for(let a of n){i[a.colorName]||(i[a.colorName]={}),i[a.colorName][a.groupName]||(i[a.colorName][a.groupName]={});let s=a.name;i[a.colorName][a.groupName][s]||(i[a.colorName][a.groupName][s]={...a,prescriptions:[]}),i[a.colorName][a.groupName][s].prescriptions.push({date:a.date,hosp:a.hosp,days:a.medDays,drugLeft:a.drugLeft})}let c="";for(let a of r){if(!i[a])continue;let s=fe[a];for(let[u,f]of Object.entries(i[a]))for(let b of Object.values(f)){b.prescriptions.sort((m,g)=>(g.date||"").localeCompare(m.date||""));let l=b.prescriptions.slice(0,3).map(m=>`<span class="med-pres">${d(x(m.date))} ${d(m.hosp)}${m.drugLeft&&m.drugLeft!=="0"?` <span class="drug-left">\u9918${m.drugLeft}\u5929</span>`:""}</span>`).join(" ");c+=`<tr>
  ...
  <div class="tracking-note">${e} \u5929\u5167</div>`}function Ce(t,o){if(!t||t.length===0)return'<p class="empty">\u7121\u897F\u85E5\u7D00\u9304</p>';let e=o||100,n=[];for(let a of t){let s=a.PER_DATE||a.drug_date||"";if(!w(s,e))continue;let u=a.ATC_CODE||a.drug_atc7_code||"";q(u)||n.push({name:a.MED_DESC||a.MED_ITEM||a.drug_ename||"",generic:a.GENERIC_NAME||a.drug_ing_name||"",date:v(s),hosp:$(a.HOSP_NAME||a.hosp),icd:a.ICD_CODE||a.icd_code||"",icdName:a.ICD_NAME||a.icd_cname||"",freq:a.FREQ_DESC||a.drug_fre||"",medDays:a.MED_DAYS||a.day||"",drugLeft:a.DRUG_LEFT||a.drug_left||""})}if(n.length===0)return'<p class="empty">\u7121\u5176\u4ED6\u897F\u85E5\u7D00\u9304</p>';let r={};for(let a of n){let s=`${a.date}|${a.hosp}`;r[s]||(r[s]={date:a.date,hosp:a.hosp,icd:a.icd,icdName:a.icdName,meds:[]}),r[s].meds.push(a)}let i=Object.values(r).sort((a,s)=>(s.date||"").localeCompare(a.date||"")),c="";for(let a of i){c+=`<div class="med-group-header">${d(x(a.date))} ${d(a.hosp)}`,a.icd&&(c+=` <span class="diag-code">${d(a.icd)}</span>`),c+="</div>";for(let s of a.meds){let u=[s.freq,s.medDays?s.medDays+"\u5929":"",s.drugLeft&&s.drugLeft!=="0"?`\u9918${s.drugLeft}\u5929`:""].filter(Boolean).join(" ");c+=`<div class="med-item">${d(s.name)} <span class="med-detail">${d(u)}</span></div>`}}return c+=`<div class="tracking-note">${e} \u5929\u5167</div>`,c}function ve(t){if(!t||t.length===0)return'<p class="empty">\u7121\u4E2D\u85E5\u7D00\u9304</p>';let o={};for(let n of t){let r=v(n.func_date||""),i=$(n.hosp),c=`${r}|${i}`;o[c]||(o[c]={date:r,hosp:i,icd:n.icd_code||"",icdName:n.icd_cname||"",meds:[]}),o[c].meds.push(n)}let e="";for(let n of Object.values(o)){e+=`<div class="med-group-header">${d(x(n.date))} ${d(n.hosp)}`,n.icd&&(e+=` <span class="diag-code">${d(n.icd)}</span>`),e+="</div>";for(let r of n.meds){let i=r.drug_perscrn_name||r.cdrug_name||"",c=r.order_qty||"",a=r.drug_fre||"",s=r.day||"";e+=`<div class="med-item">${d(i)} <span class="med-detail">${d(c)} ${d(a)} ${s?s+"\u5929":""}</span></div>`}}return e}var ye=new Set(["33085B","33084B","33072B","33070B","19009C","19001C","18006C","28016C"]);function De(t){if(!t||t.length===0)return'<p class="empty">\u7121\u5F71\u50CF\u8CC7\u6599</p>';let o=180,e=t.filter(c=>{let a=c.real_inspect_date||c.case_time||c.recipe_date||"";if(!w(a,o))return!1;let s=c.order_code||"";return ye.has(s)});if(e.length===0)return`<p class="empty">${o}\u5929\u5167\u7121\u95DC\u6CE8\u7684\u5F71\u50CF\u6AA2\u67E5</p>`;let n=new Set,r=[];for(let c of e){let a=v(c.real_inspect_date||c.case_time||c.recipe_date||""),s=c.order_name||"",u=c.order_code||"",f=`${a}|${s}|${u}`;n.has(f)||(n.add(f),r.push(c))}r.sort((c,a)=>{let s=v(c.real_inspect_date||c.case_time||c.recipe_date||"");return v(a.real_inspect_date||a.case_time||a.recipe_date||"").localeCompare(s)});let i="";for(let c of r){let a=x(c.real_inspect_date||c.case_time||c.recipe_date||""),s=c.order_name||"";s=s.replace(/[[\]]/g,"").replace(/;/g," ").trim();let u=$(c.hosp),f=c.inspect_result||"";i+='<div class="imaging-item">',i+=`<div class="imaging-name">${d(s)}</div>`,i+=`<div class="imaging-meta">${d(a)} ${d(u)}</div>`,f&&(i+=`<div class="imaging-result">${d(f)}</div>`),i+="</div>"}return i+=`<div class="tracking-note">${o} \u5929\u5167</div>`,i}function _e(t){if(!t||t.length===0)return'<p class="empty">\u7121\u904E\u654F\u7D00\u9304</p>';let o=t.filter(n=>{let r=n.drug_name||"";return r&&!r.includes("\u672A\u8A18\u9304")&&r!=="NP"&&r!=="N.P"&&r!=="N.P."&&!r.includes("\u672A\u904E\u654F")});if(o.length===0)return'<p class="empty">\u7121\u904E\u654F\u7D00\u9304</p>';let e="";for(let n of o){let r=n.drug_name||"",i=(n.sympton_name||"").replace(/;/g,", ");e+=`<div class="allergy-item"><strong>${d(r)}</strong>${i?` \u2014 ${d(i)}`:""}</div>`}return e}function xe(t){if(!t||t.length===0)return"";let o="";for(let e of t){let n=x(e.exe_s_date||""),r=$(e.hosp),i=e.icd_cname||e.icd_code||"";o+=`<div class="record-item">${d(n)} ${d(r)} \u2014 ${d(i)}</div>`}return o}function Se(t){if(!t||t.length===0)return"";let o="";for(let e of t){let n=x(e.in_date||""),r=x(e.out_date||""),i=$(e.hosp),c=e.icd_cname||e.icd_code||"";o+=`<div class="record-item">${d(n)}~${d(r)} ${d(i)} \u2014 ${d(c)}</div>`}return o}function $e(t,o,e,n){let r="";return n.allergyHtml&&!n.allergyHtml.includes("\u7121\u904E\u654F")&&(r+=`<div class="panel"><div class="panel-title" onclick="togglePanel(this)">\u26A0 \u904E\u654F\u7D00\u9304</div><div class="panel-body">${n.allergyHtml}</div></div>`),n.surgeryHtml&&(r+=`<div class="panel"><div class="panel-title" onclick="togglePanel(this)">\u{1F52A} \u624B\u8853\u7D00\u9304</div><div class="panel-body">${n.surgeryHtml}</div></div>`),n.dischargeHtml&&(r+=`<div class="panel"><div class="panel-title" onclick="togglePanel(this)">\u{1F3E5} \u51FA\u9662\u6458\u8981</div><div class="panel-body">${n.dischargeHtml}</div></div>`),`<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
